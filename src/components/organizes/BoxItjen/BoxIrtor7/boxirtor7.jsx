...
// Import Assets
import { ImgIr7 } from "../../../../assets/assets";
...
// Main Code
  return (
    <BackgroundPf color="warning">
      <ProfileBox>
        <Avatar alt="inspektorat VII" src={ImgIr7} size="lg" />
        <NameBox>
          <Pfposition>Inspektorat VII</Pfposition>
          <Pfname>Ahmad Ghufron</Pfname>
        </NameBox>
      </ProfileBox>
    </BackgroundPf>
  );
