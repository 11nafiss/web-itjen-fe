...
// Import Assets
import { ImgIr2 } from "../../../../assets/assets";
...
// Main Code
  return (
    <BackgroundPf color="warning">
      <ProfileBox>
        <Avatar alt="inspektorat II" src={ImgIr2} size="lg" />
        <NameBox>
          <Pfposition>Inspektorat II</Pfposition>
          <Pfname>Dr. Nur Achmad</Pfname>
        </NameBox>
      </ProfileBox>
    </BackgroundPf>
  );
