...
// Import Assets
import { ImgIr4 } from "../../../../assets/assets";
...
// Main Code
  return (
    <BackgroundPf color="warning">
      <ProfileBox>
        <Avatar alt="inspektorat IV" src={ImgIr4} size="lg" />
        <NameBox>
          <Pfposition>Inspektorat IV</Pfposition>
          <Pfname>Roberth Gonijaya</Pfname>
        </NameBox>
      </ProfileBox>
    </BackgroundPf>
  );
