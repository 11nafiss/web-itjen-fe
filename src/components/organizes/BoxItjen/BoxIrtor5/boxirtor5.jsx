...
// Import Assets
import { ImgIr5 } from "../../../../assets/assets";
...
// Main Code
  return (
    <BackgroundPf color="warning">
      <ProfileBox>
        <Avatar alt="inspektorat V" src={ImgIr5} size="lg" />
        <NameBox>
          <Pfposition>Inspektorat V</Pfposition>
          <Pfname>Sudarso</Pfname>
        </NameBox>
      </ProfileBox>
    </BackgroundPf>
  );
