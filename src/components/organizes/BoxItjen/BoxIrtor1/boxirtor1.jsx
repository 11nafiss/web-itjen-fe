...
// Import Assets
import { ImgIr1 } from "../../../../assets/assets";
...
// Main Code
  return (
    <BackgroundPf color="warning">
      <ProfileBox>
        <Avatar alt="inspektorat I" src={ImgIr1} size="lg" />
        <NameBox>
          <Pfposition>Inspektorat I</Pfposition>
          <Pfname>Belis Siswanto</Pfname>
        </NameBox>
      </ProfileBox>
    </BackgroundPf>
  );
