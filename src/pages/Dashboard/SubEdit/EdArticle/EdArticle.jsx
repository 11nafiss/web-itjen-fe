            ...
            <SpaceGrid container sx={{ justifyContent: { xs: "center", md: "left" }, paddingTop: "10px" }}>
              <GridFlex item xs={12} md={6} sx={{ justifyContent: { xs: "center", md: "left" } }}>
                <FormControl sx={{ width: "100%" }}>
                  ...
                  <Input size="lg" name="Size" placeholder="Tulis..." sx={{ width: "100%", borderColor: "#252525" }} />
                </FormControl>
                  ...
                  <FormControl sx={{ width: "100%" }}>
                    ...
                    <Box sx={{ width: "100%", display: "flex", flexDirection: "row", alignItems: "center" }}>
                      ...
                      <Link to="/dashboard/kategori/tambah">
                        <IconButton aria-label="upload btn" color="neutral" sx={{ backgroundColor: "#252525", color: "#fff", "&:hover": { color: "#252525" }, height: "100%", borderRadius: "0px 10px 10px 0px" }} onClick={handleClickUpload}>
                          <AddIcon />
                        </IconButton>
                      </Link>
                    </Box>
